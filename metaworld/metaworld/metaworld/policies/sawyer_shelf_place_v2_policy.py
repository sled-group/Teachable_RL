...
class SawyerShelfPlaceV2Policy(Policy):
    ...
    def get_action(self, obs: npt.NDArray[np.float64]) -> npt.NDArray[np.float32]:
        ...
        action["delta_pos"],language = self._desired_pos(o_d)
